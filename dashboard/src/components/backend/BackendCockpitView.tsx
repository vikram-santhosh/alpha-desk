  ...
  return (
    ...
    >
      ...
      <motion.div variants={rise}>
        <GlassCard className="p-5" glow={Object.values(states).every((state) => state === "live") ? "emerald" : "amber"} hoverLift={false}>
          <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
            ...
            <StatusBadge variant={Object.values(states).every((state) => state === "live") ? "success" : "warning"}>
              {Object.values(states).every((state) => state === "live") ? "All live" : "Backend incomplete"}
            </StatusBadge>
          </div>
        </GlassCard>
      </motion.div>
