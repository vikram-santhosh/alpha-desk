...
export function JudgePanel({ judge }: { judge?: JudgeAnalysis }) {
  return (
    <aside className="rounded-2xl border border-white/10 bg-white/[.035] p-5" aria-label="Fusion judge analysis">
      <div className="flex items-start justify-between gap-4">
        <div>
          <p className="data-text text-xs uppercase text-[var(--muted)]">Fusion judge</p>
